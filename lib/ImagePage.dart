...
class ImagePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Take a photo of your trash',
      home: MyHomePage(title: 'Take a photo of your trash'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
        ...
        children: <Widget>[
          Semantics(
            ...
            child: FloatingActionButton(
              backgroundColor: Color(0xffDF9A57),
              onPressed: () {
                isVideo = false;
                _onImageButtonPressed(ImageSource.gallery, context: context);
              },
              heroTag: 'image0',
              tooltip: 'Pick an image from your device!',
  ...
  Future<void> _displayPickImageDialog(
    ...
    return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            title: Text('Image Format Options'),
            content: Column(
              children: <Widget>[
                TextField(
                  ...
                  decoration:
                  InputDecoration(hintText: "Enter a maximum width for image"),
                ),
                TextField(
                  ...
                  decoration:
                  InputDecoration(
                      hintText: "Enter a maximum height for image"
                  ),
                ),
                TextField(
                  ...
                  decoration:
                  InputDecoration(
                      hintText: "Enter preferred quality of image",
                  ),
                ),
              ],
            ),
